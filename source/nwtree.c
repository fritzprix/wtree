...
static void traverse_base_rc(nwtreeNode_t* node, nwt_callback_t callback, void* arg);
...
void nwtree_traverseBaseNode(nwtreeRoot_t* root, nwt_callback_t callback, void* arg) {
	if (!root)
		return;
